...
Simulation of thread scheduling algorithms for personal training purposes.
...
Then STDIN reads the priority, start time and runtime for each of the threads in the following format:
```
